...
ProjectOglowia-Linux-Debug:
	 $(PROJECTBUILD) ProjectOglowia Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowia-Linux-DebugGame:
	 $(PROJECTBUILD) ProjectOglowia Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowia-Linux-Shipping:
	 $(PROJECTBUILD) ProjectOglowia Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowia-Linux-Test:
	 $(PROJECTBUILD) ProjectOglowia Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowia:
	 $(PROJECTBUILD) ProjectOglowia Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowiaEditor-Linux-Debug:
	 $(PROJECTBUILD) ProjectOglowiaEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowiaEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ProjectOglowiaEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowiaEditor-Linux-Shipping:
	 $(PROJECTBUILD) ProjectOglowiaEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowiaEditor-Linux-Test:
	 $(PROJECTBUILD) ProjectOglowiaEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ProjectOglowiaEditor:
	 $(PROJECTBUILD) ProjectOglowiaEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
