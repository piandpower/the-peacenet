...
unrealRootPath=/ssdhome/UnrealEngine
ProjectOglowiaRootPath=/home/alkaline/Documents/Git/peacenet-ue 4.20

gameProjectFile=/home/alkaline/Documents/Git/peacenet-ue 4.20/ProjectOglowia.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(ProjectOglowiaSource.pri)
include(ProjectOglowiaHeader.pri)
include(ProjectOglowiaConfig.pri)
include(ProjectOglowiaIncludes.pri)
include(ProjectOglowiaDefines.pri)
...
ProjectOglowia-Linux-Debug.commands = $$build ProjectOglowia Linux Debug  -project="\"$$gameProjectFile\"" $$args
ProjectOglowia-Linux-DebugGame.commands = $$build ProjectOglowia Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ProjectOglowia-Linux-Shipping.commands = $$build ProjectOglowia Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ProjectOglowia-Linux-Test.commands = $$build ProjectOglowia Linux Test  -project="\"$$gameProjectFile\"" $$args
ProjectOglowia.commands = $$build ProjectOglowia Linux Development  -project="\"$$gameProjectFile\"" $$args

ProjectOglowiaEditor-Linux-Debug.commands = $$build ProjectOglowiaEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ProjectOglowiaEditor-Linux-DebugGame.commands = $$build ProjectOglowiaEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ProjectOglowiaEditor-Linux-Shipping.commands = $$build ProjectOglowiaEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ProjectOglowiaEditor-Linux-Test.commands = $$build ProjectOglowiaEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ProjectOglowiaEditor.commands = $$build ProjectOglowiaEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	ProjectOglowia-Linux-Debug \
	ProjectOglowia-Linux-DebugGame \
	ProjectOglowia-Linux-Shipping \
	ProjectOglowia-Linux-Test \
	ProjectOglowia \
	ProjectOglowiaEditor-Linux-Debug \
	ProjectOglowiaEditor-Linux-DebugGame \
	ProjectOglowiaEditor-Linux-Shipping \
	ProjectOglowiaEditor-Linux-Test \
	ProjectOglowiaEditor \
