...
TMap<FString, FDocoptValue> UDocoptForUnrealBPLibrary::NativeParseArguments(const FString& InDoc, const TArray<FString> InArgv, bool InHelp, const FString& InVersion, bool InOptionsFirst, bool& OutHasMessage, FString& OutMessage)
{
	...
	catch (docopt::DocoptLanguageError const&) {
...
TMap<FString, FDocoptValue> UDocoptForUnrealBPLibrary::ParseArguments(const FString& InDoc, const TArray<FString> InArgv, bool InHelp, const FString& InVersion, bool InOptionsFirst, bool& OutHasMessage, FString& OutMessage)
{
